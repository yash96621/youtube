...
function SearchSuggestion() {
  ...
  return (
    <div>
      <div className=" max-sm:w-screen max-sm:h-96 max-sm:bg-transparent max-sm:text-white top-16  w-[550px] max-lg:w-[360px]  h-96 overflow-y-scroll bg-slate-100 rounded-2xl absolute">
