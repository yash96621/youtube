...
function BellVideo() {
  return (
    <div className="flex space-x-2 py-3   hover:bg-sky-500 hover:shadow-2xl overflow-hidden justify-between px-2">
      <div className=" w-16 h-16 max-sm:w-9 max-sm:h-9 rounded-full bg-slate-800"></div>
      <div>
